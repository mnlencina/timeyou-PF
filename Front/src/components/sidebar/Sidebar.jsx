    ...
    <Container>
      <nav className="main-menu">
            ...
            {sortedBrands.map((brand) => (
              <li key={brand}>
                <a href={brand}>
                  ...
                  <label className="nav-text" htmlFor={brand}>
                    <input
                      id={brand}
                      name="Marca"
                      type="checkbox"
          ...
          <ul>
            ...
            {sortedColors.map((color) => (
              <li key={color}>
                <a href={color}>
                  <i className="fa fa-home fa-2x"></i>
                  <label className="nav-text" htmlFor={color}>
                    <input
                      id={color}
                      name="Color"
                      type="checkbox"
          ...
          <ul>
            ...
            {sortedGenders.map((gender) => (
              <li key={gender}>
                <a href={gender}>
                  <i className="fa fa-home fa-2x"></i>
                  <label className="nav-text" htmlFor={gender}>
                    <input
                      type="checkbox"
                    ...
                    />
                    {`- ${
                      translateGender(gender).charAt(0).toUpperCase() +
                      translateGender(gender).slice(1)
                    }`}
                  </label>
                </a>
              </li>
          ...
          <ul>
            ...
            {sortedStyles.map((style) => (
              <li key={style}>
                <a href={style}>
                  <i className="fa fa-home fa-2x"></i>
                  <label className="nav-text" htmlFor={style}>
                    <input
                      type="checkbox"
          ...
          <ul>
            ...
            {sortedStraps.map((strap) => (
              <li key={strap}>
                <a href={strap}>
                  <i className="fa fa-home fa-2x"></i>
                  <label className="nav-text" htmlFor={strap}>
                    <input
                      id={strap}
                      type="checkbox"
        ...
        <span className="logout">
          <button id="limpiar" onClick={handleClearFilters}>
            Limpiar filtros
          </button>
          <button id="filtrar" onClick={handleApplyFilters}>
            Aplicar filtros
          </button>
        </span>
      </nav>
